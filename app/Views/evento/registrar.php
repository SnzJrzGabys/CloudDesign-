    ...
    <div class="container py-2">
        <form method="post" id="add_create" name="add_create" action="<?php echo base_url('/evento/insert'); ?>">
            <div class="form-group">
                ...
                <?= form_input(['id' => 'nombre', 'name' => 'nombre', 'class' => 'form-control', 'placeholder' => 'Evento']); ?>
            ...
            <div class="form-group">
                ...
                <?= form_input(['id' => 'lugar', 'name' => 'lugar', 'class' => 'form-control', 'placeholder' => 'lugar']); ?>
            ...
            <div class="form-group">
                ...
                <?= form_input(['id' => 'fecha', 'name' => 'fecha', 'type' => 'date', 'class' => 'form-control', 'placeholder' => 'Fecha']); ?>
            </div>
            <div class="form-group">

                <?= form_label('Horario', 'for_horario', ['class' => 'control-label']); ?>

                <?= form_input(['id' => 'horario', 'name' => 'horario', 'type' => 'time', 'class' => 'form-control', 'placeholder' => 'Horario']); ?>
            ...
            <div class="form-group">
                ...
                <?= form_input(['id' => 'organizador', 'name' => 'organizador', 'class' => 'form-control', 'placeholder' => 'Organizador']); ?>
            </div>
            <div class="form-group">
                <?= form_label('Objetivo', 'for_categoria', ['class' => 'control-label']); ?>

                <?= form_input(['id' => 'objetivo', 'name' => 'objetivo', 'class' => 'form-control', 'placeholder' => 'Objetivo']); ?>
            </div>
            <div class="form-group">

                <?= form_label('Academia', 'for_academia', ['class' => 'control-label']); ?>

                <?= form_input(['id' => 'academia', 'name' => 'academia', 'class' => 'form-control', 'placeholder' => 'Academia']); ?>
            ...
            <div class="form-group">
                ...
                <?= form_input(['id' => 'recursos', 'name' => 'recursos', 'class' => 'form-control', 'placeholder' => 'Recursos']); ?>

            </div>
            <div class="form-group"><?= form_label('Número de participantes', 'for_existencias', ['class' => 'control-label']); ?><?= form_input(['id' => 'numero_participantes', 'name' => 'numero_participantes', 'class' => 'form-control', 'placeholder' => 'Número de participantes']); ?>
